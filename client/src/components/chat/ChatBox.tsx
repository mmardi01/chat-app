...
function ChatBox() {
  return (
    <div className="w-[60%] text-[#303030] h-full flex flex-col bg-white rounded-[20px] shadow-[#79c6ef46] shadow-md p-6">
      <ChatBoxHeader />
      <MessagesArea />
      <div className="flex w-full h-16 justify-between">
        <div className="w-[90%]  h-full bg-[#EFF6FC] gap-6 text-2xl items-center rounded-[20px] flex px-6">
          ...
          <input className="placeholder:font-light w-full placeholder:text-[#303030] placeholder:text-xl outline-none font-light text-[#303030] text-xl bg-transparent" placeholder="Type your message here..." type="" />
